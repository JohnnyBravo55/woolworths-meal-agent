...
_PHRASE_ACCEPT: dict[str, tuple[str, ...]] = {
    ...
    "spinach": ("baby spinach", "english spinach", "fresh spinach"),
    "fresh spinach": ("baby spinach", "english spinach", "fresh spinach"),
    "lettuce": ("shredded lettuce", "iceberg lettuce", "cos lettuce", "baby cos"),
    "whole grain bread": (
        "multigrain",
        "wholemeal",
        "whole grain",
...
_INGREDIENT_REJECT: dict[str, tuple[str, ...]] = {
    ...
    "chicken breast": ("nugget", "tenders", "crumb", "schnitzel", "pie", "stock", "broth", "kebab", "thigh"),
    "chicken thigh": ("nugget", "tenders", "crumb", "schnitzel", "pie", "stock", "broth", "kebab", "breast"),
    "chicken thighs": ("nugget", "tenders", "crumb", "schnitzel", "pie", "stock", "broth", "kebab", "breast"),
    ...
    "beef mince": ("pork", "chicken", "lamb", "sausage", "pie", "patty", "burger", "cat", "dog", "pet", "gravy"),
    "beef": ("pork", "chicken", "lamb", "sausage", "cat", "dog", "pet"),
    "broccoli": ("bite", "bites", "cheese", "soup", "kit", "salad", "rice"),
    "broccoli head": ("bite", "bites", "cheese", "soup", "kit", "salad", "rice"),
    "courgette": ("puree", "pureed", "months", "baby", "quinoa", "pickle", "pickled", "relish"),
    "snap peas": ("crisp", "crisps", "harvest", "shoot", "shoots", "mix", "steam"),
    "snap pea": ("crisp", "crisps", "harvest", "shoot", "shoots", "mix", "steam"),
    "rice": ("cracker", "cake", "milk", "wine", "vinegar", "paper", "pudding", "noodle", "noodles", "pho"),
    ...
    "cheese": ("cake", "ball", "sauce", "spread", "roll", "stick", "sticks", "scone", "mince", "savoury"),
    "parmesan cheese": ("mozzarella", "edam", "cheddar", "colby", "tasty", "mince", "savoury"),
    "parmesan": ("mozzarella", "edam", "cheddar", "colby", "tasty", "mince", "savoury"),
    "honey": (
        "cashew",
        "roasted",
        "mustard",
    ...
    "cream": ("lamington", "cake", "biscuit", "cookie", "ice", "yoghurt", "yogurt"),
    "cherry tomatoes": ("tuna", "chilli", "chili", "pasta", "sauce", "soup", "juice"),
    "cherry tomato": ("tuna", "chilli", "chili", "pasta", "sauce", "soup", "juice"),
    "lettuce": ("sandwich", "wrap", "burger", "roll", "kit", "salad kit"),
    "cucumber": (
        "sandwich",
        "wrap",
        "burger",
...
def pick_best_product(
    ...
    *,
    ...
    for cand in candidates:
        ...
        size = str(cand.get("size") or cand.get("display") or "")
        score_name = " ".join(x for x in (name, size) if x).strip() or name
        score = score_product_name(ingredient, score_name, brand)
        if score <= 0:
            continue
